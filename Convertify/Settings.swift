...
class Settings {
    ...
    public static let HOST = "thegrandbazzar.com" /// if url has "www" then add host like "www.domain.com" else would be white screen
    
    public static let URL = "http://thegrandbazzar.com"
